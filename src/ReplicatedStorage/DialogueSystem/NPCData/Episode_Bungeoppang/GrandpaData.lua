	...
	["ST_IDLE"] = {
		Nodes = {
			...
			["DH_IDLE_4"] = {
				Speaker = "Grandpa",
				Text = {
					"(귀찮은 듯) 노란 고양이? 이 동네에 고양이가 한둘이 아니야. 모르겠어.",
					"허허, 이 동네 길고양이들을 내가 다 기억할 리가 있나.",
					"글쎄... 노란색이라. 워낙 고양이가 많아서 말이야. 잘 모르겠네."
				},
				Next = "DH_IDLE_5"
			},
			["DH_IDLE_5"] = {
	...
	["ST_PHOTO_NEED"] = {
		Nodes = {
			["DH_NEED_1"] = {
				Speaker = "Grandpa",
				Text = {
					"아직인가? 하트 점이 있는 사진을 가져와야 내가 누군지 알려주지.",
					"어허, 성격도 급하구먼. 사진은 가져왔나? 없어? 어쩌라는 건가?",
					"사진 없이는 해 줄 말이 없네. 허허허"
				},
				Next = "DH_NEED_2"
			},
			["DH_NEED_2"] = {
